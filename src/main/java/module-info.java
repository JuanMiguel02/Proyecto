module triplej.banco {
    ...
    opens triplej.banco.Controllers to javafx.fxml;opens triplej.banco.Models.Usuarios to javafx.base;
    ...
    exports triplej.banco.Models.Usuarios;
    exports triplej.banco.Models.Cuentas;
